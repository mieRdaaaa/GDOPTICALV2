    ...
    <div class="container">
        ...
        <div class="details-table">
            ...
            <div class="detail-row">
                ...
                <span class="detail-value"><?php echo $row['address']; ?></span>
            </div>
            <div class="detail-row">
        ...
        <div class="action-buttons">
            <a href="secretary_edit.php?id=<?php echo $row['patients_id']; ?>" class="action-btn edit-btn"><i class="fa fa-edit"></i>Edit</a>
            <a href="secretary_table.php" class="action-btn back-btn">Back to List</a>
        </div>
    </div>
</body>
</html>
