...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($conn->query($update_sql) === TRUE) {
        ...
        header("Location: secretary_view.php?id=$id");  // Redirect to secretary_view.php
        exit;
    } else {
    ...
    <div class="container">
        ...
        <form method="POST" action="">
            ...
            <div class="form-group">
                ...
                <input type="text" id="contact_no" name="contact_no" value="<?php echo htmlspecialchars($row['contact_no']); ?>" required>
            </div>
            <div class="form-group">
                <label for="address"><i class="fa fa-home"></i> Address:</label>  <!-- Address field -->
            ...
            <div class="action-buttons">
                <button type="submit" class="action-btn save-btn" onclick="return alert('Record updated successfully')"><i class="fa fa-save"></i> Save</button>
                <a href="secretary_view.php?id=<?php echo $row['patients_id']; ?>" class="action-btn cancel-btn"><i class="fa fa-times"></i> Cancel</a>
            </div>
        </form>
    </div>
</body>
